...
//
//  Date Created : 8/4/2017 10:09:02 AM
// 
//  Online Resource  : www.electronicsforstudents.com
//
//  Libraries Included : -->gprs -->gps -->gsm -->power_reset 
/////////////////////////////////////////////////////////////////////////////////////////////////////
...
int main()
{
	...
	while (1)
	{
		...
		if(gps_fix()==1)
		{
			...
			sprintf(url,"api.clobous.com/KED515/track?&lat=%s&long=%s&speed=%s",lat,lon,speed);
